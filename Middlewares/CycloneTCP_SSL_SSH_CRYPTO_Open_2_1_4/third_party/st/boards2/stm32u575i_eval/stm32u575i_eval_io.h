/**
  ******************************************************************************
  * @file    stm32u575i_eval_io.h
  * @author  MCD Application Team
  * @brief   This file contains the common defines and functions prototypes for
  *          the stm32u575i_eval_io.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32U575I_EVAL_IO_H
#define STM32U575I_EVAL_IO_H
...
/** @addtogroup STM32U575I_EVAL_IO
  * @{
  */

/** @defgroup STM32U575I_EVAL_IO_Exported_Types IO Exported Types
  * @{
  */
typedef struct
{
...
/** @defgroup STM32U575I_EVAL_IO_Exported_Constants IO Exported Constants
  * @{
  */
/**
...
/**
  * @brief IOExpander IT pins control
  */
...
/**
  ...
  */
#define MFX_IRQOUT_PIN                    GPIO_PIN_5
#define MFX_IRQOUT_GPIO_PORT              GPIOC
#define MFX_IRQOUT_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOC_CLK_ENABLE()
#define MFX_IRQOUT_GPIO_CLK_DISABLE()     __HAL_RCC_GPIOC_CLK_DISABLE()
#define MFX_IRQOUT_EXTI_IRQn              EXTI5_IRQn
#define IO_EXTI_LINE                      EXTI_LINE_5

#define IO_I2C_ADDRESS                    0x84U
#define IO_I2C_ADDRESS_2                  0x86U

/**
  * @brief MFX_WAKEUP pin
  */
#define IOEXPANDER_WAKEUP_GPIO_PORT           GPIOF
#define IOEXPANDER_WAKEUP_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOF_CLK_ENABLE()
#define IOEXPANDER_WAKEUP_GPIO_CLK_DISABLE()  __HAL_RCC_GPIOF_CLK_DISABLE()
#define IOEXPANDER_WAKEUP_PIN                 GPIO_PIN_11
/**
  * @}
  */

/** @addtogroup STM32U575I_EVAL_IO_Exported_Variables
  * @{
  */
