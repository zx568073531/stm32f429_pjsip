/**
  ******************************************************************************
  * @file    stm32u575i_eval_usbpd_pwr.h
  * @author  MCD Application Team
  * @brief   Header file for stm32u575i_eval_usbpd_pwr.c file
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32U575I_EVAL_USBPD_PWR_H
#define STM32U575I_EVAL_USBPD_PWR_H
...
/** @defgroup STM32U575I_EVAL_USBPD_PWR_Exported_Types Exported Types
  * @{
  */
...
/** @defgroup STM32U575I_EVAL_USBPD_PWR_Exported_Constants Exported Constants
  * @{
  */
/**
...
/**
  * @brief  ADC instance for VBUS Sensing
  */
...
/* 5V_UCPD : PA5, ADC12_IN10 */
#define VSENSE_GPIO_PORT                GPIOA
#define VSENSE_GPIO_PIN                 LL_GPIO_PIN_5
...
#define VSENSE_ADC_CHANNEL              LL_ADC_CHANNEL_10

/**
  * @brief TCPP0203_FLGn pin
  * To be defined for each Port, protected by a TCPP0203 component
  */
#define TCPP0203_PORT0_FLG_GPIO_CLK_ENABLE()        LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOB);
#define TCPP0203_PORT0_FLG_GPIO_CLK_DISABLE()       LL_AHB2_GRP1_DisableClock(LL_AHB2_GRP1_PERIPH_GPIOB);
#define TCPP0203_PORT0_FLG_GPIO_PORT                GPIOB
...
#define TCPP0203_PORT0_FLG_SET_EXTI()               LL_EXTI_SetEXTISource(LL_EXTI_EXTI_PORTB, (LL_EXTI_EXTI_LINE8));
#define TCPP0203_PORT0_FLG_EXTI_LINE                LL_EXTI_LINE_8
#define TCPP0203_PORT0_FLG_EXTI_ENABLE()            do { \
...
#define TCPP0203_PORT0_FLG_TRIG_ENABLE()            do { \
...
#define TCPP0203_PORT0_ADC_CLK_ENABLE()            __HAL_RCC_ADC1_CLK_ENABLE()
#define TCPP0203_PORT0_ADC_CLK_DISABLE()           __HAL_RCC_ADC1_CLK_DISABLE()
#define TCPP0203_PORT0_ADC_FORCE_RESET()           __HAL_RCC_ADC1_FORCE_RESET()
#define TCPP0203_PORT0_ADC_RELEASE_RESET()         __HAL_RCC_ADC1_RELEASE_RESET()

/* Definition of ADCx channels */
#define TCPP0203_PORT0_IANA_ADC_CHANNEL             ADC_CHANNEL_1           /* PA0 : ADC2_IN11 */
#define TCPP0203_PORT0_VBUSC_ADC_CHANNEL            ADC_CHANNEL_10          /* PA5 : ADC12_IN1 */
#define TCPP0203_PORT0_ADCXCHANNELN                 (2U)

#define TCPP0203_PORT0_IANA_GPIO_CLK_ENABLE()       LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOA);
#define TCPP0203_PORT0_IANA_GPIO_CLK_DISABLE()      LL_AHB2_GRP1_DisableClock(LL_AHB2_GRP1_PERIPH_GPIOA);
#define TCPP0203_PORT0_IANA_GPIO_PORT               GPIOA
#define TCPP0203_PORT0_IANA_GPIO_PIN                LL_GPIO_PIN_0
...
#define TCPP0203_PORT0_VBUSC_GPIO_PIN               LL_GPIO_PIN_5
...
/** @addtogroup STM32U575I_EVAL_USBPD_PWR_Exported_Variables
  * @{
  */
/**
  * @}
...
/** @defgroup STM32U575I_EVAL_USBPD_PWR_Exported_Functions Exported Functions
  * @{
  */
/* Common functions */
...
#endif /* STM32U575I_EVAL_USBPD_PWR_H */
