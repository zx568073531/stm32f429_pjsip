...
#pragma data_alignment = 4
 uint8_t txBuffer[STM32F4XX_ETH_TX_BUFFER_COUNT][STM32F4XX_ETH_TX_BUFFER_SIZE];
//Receive buffer
#pragma data_alignment = 4
 uint8_t rxBuffer[STM32F4XX_ETH_RX_BUFFER_COUNT][STM32F4XX_ETH_RX_BUFFER_SIZE];
//Transmit DMA descriptors
#pragma data_alignment = 4
 Stm32f4xxTxDmaDesc txDmaDesc[STM32F4XX_ETH_TX_BUFFER_COUNT];
//Receive DMA descriptors
#pragma data_alignment = 4
 Stm32f4xxRxDmaDesc rxDmaDesc[STM32F4XX_ETH_RX_BUFFER_COUNT];
...
//Pointer to the current TX DMA descriptor
 Stm32f4xxTxDmaDesc *txCurDmaDesc;
//Pointer to the current RX DMA descriptor
 Stm32f4xxRxDmaDesc *rxCurDmaDesc;
