...
copy ..\..\..\..\cyclone_ssh\sftp\sftp_client*.c main\cyclone_ssh\sftp
copy ..\..\..\..\cyclone_ssh\sftp\sftp_common.c main\cyclone_ssh\sftp

REM CycloneSSH Headers
copy ..\..\..\..\cyclone_ssh\ssh\*.h main\cyclone_ssh\ssh
copy ..\..\..\..\cyclone_ssh\sftp\sftp_client*.h main\cyclone_ssh\sftp
copy ..\..\..\..\cyclone_ssh\sftp\sftp_common.h main\cyclone_ssh\sftp
